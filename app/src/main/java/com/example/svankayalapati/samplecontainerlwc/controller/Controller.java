package com.example.svankayalapati.samplecontainerlwc.controller;
...
import com.example.svankayalapati.samplecontainerlwc.app.SAApplication;
...
import com.example.svankayalapati.samplecontainerlwc.model.BaseModel;
...
public class Controller {
	...
	public Controller(Context context) {
		System.out.println("Controller.Controller(Context context)");
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (mView.isEnabled()) {
						...
						if (listItemObj.classObj != null) {
							...
							activityLauncherRef = new ActivityLauncher() {
								...
								public void launchActivity() {
                                    ...
                                    System.out.println("Controller.launchActivity(" + listItemObj.name + ")");
					...
					case DISPLAY_ACTIVITY:
                        ...
                        System.out.println("case DISPLAY_ACTIVITY(" + listItemObj.name + ")");
	...
	public boolean activateAdmin() {
        System.out.println("Controller.activateAdmin()");
	...
	public boolean deactivateAdmin() {
        System.out.println("Controller.deActivateAdmin()");
	...
	public void activateKLMWithAdminEnabled(String klmsKey) {
        System.out.println("Controller.activateKLMWithAdminEnabled()");
	...
	public void activateELMWithAdminEnabled(String elmKey) {
        System.out.println("Controller.activateELMWithAdminEnabled()");
	...
	public void activateKLM(String klmsKey) {
        System.out.println("Controller.activateKLM()");
	...
	public void activateELM(String elmKey) {
        ...
        System.out.println("Controller.activateELM()");
	...
	public static void freeInstance(int type) {
        ...
        System.out.println("Controller.freeInstance()");
	...
	public static void showAlertWithList(String[] arr, String heading, String key) {
		...
		System.out.println("Controller::showAlertWithList()");
	...
	public static Object getSharedPrefData(String key, int dataType) {
        System.out.println("Controller.getSharedPrefData()");
		if (mContext == null) {
	...
	public static void setSharedPrefData(String key, Object val, int dataType) {
        System.out.println("Controller.setSharedPrefData()");
		if (mContext == null) {
			mContext = SAApplication.getAppContext();
		}
		sharedpreferences = mContext.getSharedPreferences(SAConstants.MY_PREFS_NAME, Context.MODE_PRIVATE);
...
*/
	...
	public static Context getCurrentContext() {
		System.out.println("Controller.getCurrentContext()"); return mContext;
	}
}
