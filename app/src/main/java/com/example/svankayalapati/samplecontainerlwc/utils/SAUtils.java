...
//This class is used to get app version, device information,etc
...
public class SAUtils {
	...
	public static String getAppVersion(Context ctxt) {
		...
		try {
			PackageInfo pinfo = ctxt.getPackageManager().getPackageInfo(
					ctxt.getPackageName(), 0);
			appVersion = ctxt.getResources().getString(
	...
	public static String getCarrierName(Context ctxt) {
		TelephonyManager manager = (TelephonyManager) ctxt
