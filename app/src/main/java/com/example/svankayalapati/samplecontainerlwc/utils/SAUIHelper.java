package com.example.svankayalapati.samplecontainerlwc.utils;
...
public class SAUIHelper {
	...
	public static void showAlertWithList(Context ctxt, String heading,
		...
		System.out.println("SAUIHelper::showAlertWithList()");
		...
		if (arrayAdapter != null && !(arrayAdapter.isEmpty())) {
			...
			builderSingle.setNegativeButton(SAConstants.CANCEL,
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							// TODO: Remove this and below .out.
							System.out.println("SAUIHelper::onClick(int = " + which + ")");

							if (listStr != null && listStr.length > 0) {
								// save the first item of the list in Shared
								// preference
								// TODO: Remove this and below .out.
								System.out.println("listStr = " + listStr[0]);
			...
			builderSingle.setAdapter(arrayAdapter,
					new DialogInterface.OnClickListener() {
						...
						@Override
						public void onClick(DialogInterface dialog, int which) {
							// TODO remove the .outs.
							System.out.println("SAUIHelper::DialogInterfaceOnClickListener::onClick(" + which + ")");
							String strObj = arrayAdapter.getItem(which);
							System.out.println("selected item is = " + strObj);
							// save the selected item of the list in shared
							// preference
							System.out.println("Placing the selected choice into keyObj, which is the shared preferences");
